...
struct SIM
    ...
    function generate_measurements(sim::SIM, sat::SATELLITE, alb::ALBEDO, x, t, CONSTANTS)
        ...
        sᴮ = η_sun * (ᴮRᴺ * sᴵ) # (noisy) Sun vector in body frame
        Bᴮ = η_mag * (ᴮRᴺ * Bᴵ) # (noisy) Mag vector in body frame
        ...
        ϵ = sat.diodes.elev_values 
        α = sat.diodes.azi_values 
        ...
        sensors = SENSORS(Bᴮ, sᴮ, current_vals)
